...
#define BUTTON_OPTIONS_HINTS_ON 18 //DODANE OSTATNIO
#define BUTTON_OPTIONS_HINTS_OFF 19 //DODANE OSTATNIO
#define BUTTON_OPTIONS_RESET 20
     /*DEPLOYING*/
#define BUTTON_DEPLOYING_DONE 21
#define BUTTON_DEPLOYING_BACK 22
#define BUTTON_DEPLOYING_RESET 23
     /*GAME*/
